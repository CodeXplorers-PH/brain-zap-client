                ...
                <div className="relative overflow-hidden bg-gradient-to-br from-indigo-900/80 via-purple-900/80 to-pink-800/80 rounded-3xl shadow-xl border border-purple-700/30 backdrop-blur-sm">
                    ...
                    <div className="relative z-10 text-center px-6 py-16 md:py-20 md:px-20">
                        <h2 className="text-4xl md:text-5xl font-semibold text-white mb-6">
                            Start Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-pink-400">30-Day Free Trial</span> Today!
                        </h2>

                        <p className="text-lg md:text-xl lg:text-2xl text-purple-200 mb-6 max-w-3xl mx-auto">
                            Discover the power of AI-generated quizzes. Personalized learning, endless fun! 
                            Use code <span className="font-mono bg-purple-800/50 px-2 py-1 rounded text-amber-300">BRAINZAP30</span> for a FREE 30-day trial.
                        </p>
