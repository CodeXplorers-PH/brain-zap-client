    ...
    return (
      <div className="bg-gray-900 min-h-screen pt-40 flex items-center justify-center">
        <div className="text-center p-8 bg-gray-800/50 rounded-xl border border-gray-700">
          ...
          <p className="text-gray-400 mb-6">It seems there's nothing to show here.</p>
          <button
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {showScore && (
          <div className={`mb-10 p-6 rounded-xl border ${
            score >= 70 ? 'border-green-500/30 bg-green-900/10' :
            score >= 40 ? 'border-yellow-500/30 bg-yellow-900/10' :
            ...
            <p className="text-gray-300">
              {score >= 70 ? 'Excellent work!' : 
               ...
               'Keep practicing!'} You answered {Object.values(userAnswers).filter((ans, i) => ans === correctAnswers[i]).length} out of {questions.length} questions correctly.
            </p>
          </div>
        )}
            ...
            return (
              <div
                ...
                className={`rounded-xl p-6 border ${
                  isCorrect ? 'border-green-500/30 bg-green-900/10' : 
                  isWrong ? 'border-red-500/30 bg-red-900/10' : 
                    ...
                    return (
                      <div
                        ...
                        className={`p-4 rounded-lg flex items-start border ${
                          isSelected && isCorrect ? 'border-green-500 bg-green-900/30' :
                          isSelected && isWrong ? 'border-red-500 bg-red-900/30' :
                          isCorrectOption ? 'border-green-500 bg-green-900/30' : 
                          'border-gray-700 bg-gray-800'
                        }`}
                      >
                        <span className={`font-mono mr-3 mt-0.5 ${
                ...
                <div className="mt-4">
                  {isCorrect ? (
                    ...
                    <p className="text-red-400">
                      <span className="mr-2">✗</span> The correct answer was: <span className="text-green-400 font-medium">{correctAnswer}</span>
                    </p>
                  ) : null}
                </div>
              </div>
          ...
          >
            {isFetchingFeedback ? (
              <span className="flex items-center justify-center">
                <span className="animate-spin mr-2">🌀</span> Generating Feedback...
              </span>
            ) : (
              'Get AI Feedback'
            )}
          ...
          <div className="mt-10 bg-gray-800/50 border border-gray-700 rounded-xl p-6 backdrop-blur-sm">
            ...
            <div className="space-y-6">
              <div className="p-4 bg-green-900/10 border border-green-500/30 rounded-lg">
                ...
                <p className="text-gray-300">
                  {feedback[0]?.Strengths || 'No specific strengths were identified.'}
                </p>
              </div>
              ...
              <div className="p-4 bg-red-900/10 border border-red-500/30 rounded-lg">
                ...
                <p className="text-gray-300">
                  {feedback[1]?.Weaknesses || 'No significant weaknesses were found.'}
                </p>
              </div>
