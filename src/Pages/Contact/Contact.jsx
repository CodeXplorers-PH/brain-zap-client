...
import { FiSend, FiLinkedin, FiGithub, FiBarChart2, FiTrendingUp, FiCalendar, FiAward, FiShare2, FiPrinter, FiEdit3 } from "react-icons/fi";
  ...
  const uniqueFeatures = [
    {
      ...
      description: "Generate personalized quizzes on topics you're passionate about to enhance your learning experience and knowledge retention."
    },
    {
      icon: <FiTrendingUp className="w-8 h-8" />,
      title: "Competitive Leaderboards",
      description: "Compete globally and see your rank among other learners. Challenge yourself to climb the rankings and earn recognition."
    },
    {
      icon: <FiCalendar className="w-8 h-8" />,
      title: "Daily Learning Streaks",
      description: "Build consistent learning habits with daily streak rewards. Stay motivated and track your progress over time."
    },
    {
      icon: <FiAward className="w-8 h-8" />,
      title: "Achievement System",
      description: "Earn badges and unlock rewards as you progress through various learning milestones and challenges."
    },
    {
      icon: <BsRobot className="w-8 h-8" />,
      title: "AI-Powered Feedback",
      description: "Get personalized insights on your performance with our advanced AI that analyzes your answers and provides tailored recommendations."
    },
    {
      icon: <RiUserCommunityFill className="w-8 h-8" />,
      title: "Learning Community",
      description: "Share your insights through our interactive blog section and connect with other learners who share your interests."
    },
    {
      icon: <FiPrinter className="w-8 h-8" />,
      title: "Printable Results",
      description: "Save your quiz results for later study and reference. Export your progress reports to track improvements over time."
    },
    {
      icon: <FiShare2 className="w-8 h-8" />,
      title: "Social Sharing",
      description: "Share your achievements across social media platforms and inspire others to join your learning journey."
    },
    {
      icon: <IoPieChart className="w-8 h-8" />,
      title: "Knowledge Analytics",
      description: "Track your learning progress with detailed analytics that identify strengths and areas for improvement across different subject areas."
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-40 pb-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 text-center">
            We're on a mission to revolutionize learning through AI-powered quizzes
          </p>
        </div>
              ...
              >
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="flex space-x-4 mt-2">
                    <a href={member.links.linkedin} className="text-gray-400 hover:text-purple-400" target="_blank" rel="noopener noreferrer">
                      <FiLinkedin className="w-5 h-5" />
                    </a>
                    <a href={member.links.github} className="text-gray-400 hover:text-purple-400" target="_blank" rel="noopener noreferrer">
                      <FiGithub className="w-5 h-5" />
                    </a>
                    <a href={member.links.portfolio} className="text-gray-400 hover:text-purple-400" target="_blank" rel="noopener noreferrer">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="pt-2">
                <button
                  ...
                  className={`w-full px-6 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg shadow-purple-500/20 hover:shadow-xl hover:shadow-purple-500/30 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                >
                  {isSubmitting ? (
                    <>
              ...
              {submitSuccess && (
                <div className="text-center py-3 px-4 bg-green-500/20 border border-green-500/50 rounded-lg text-green-300 mt-4">
                  Thank you! Your {formData.subject} has been received and will be reviewed by our team.
                </div>
              )}
            </form>
          </div>
