...
const testimonialData = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1544168190-79c17527004f?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y2hpbmVzZSUyMG1hbnxlbnwwfHwwfHx8MA%3D%3D",
    feedback: "As a professional constantly looking to upskill, BrainZap has been a game-changer. The personalized learning paths and detailed feedback help me focus on areas that need improvement. It's like having a personal AI tutor 24/7.",
    rating: 4.5
  },
  {
    id: 3,
    ...
    <section className="bg-neutral py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extrabold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
            What Our Users Say
          </h2>
          <p className="text-xl text-neutral-300 max-w-3xl mx-auto">
            Discover how BrainZap is revolutionizing learning through personalized, AI-powered experiences. Our users share their transformative journeys.
          </p>
        </div>
