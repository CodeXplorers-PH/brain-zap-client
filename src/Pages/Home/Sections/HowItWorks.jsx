...
import { User, Brain, Target, TrendingUp, Zap, Shield } from "lucide-react";
...
const HowItWorks = () => {
  const processSteps = [
    ...
    },
    {
      ...
      description:
        "AI insights into your strengths, weaknesses, and growth strategies.",
    ...
    <section className="bg-neutral text-neutral-content py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            <span className="font-extrabold mb-4 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-transparent bg-clip-text">
              Unlock Your Potential with <SparklesText text="BRAINZAP" className="text-white inline-block text-4xl md:text-5xl" />
            </span>
          </motion.h2>
          ...
          >
            ...
            unique journey and transforms your skills.
          </motion.p>
          <p className="text-neutral-content/80 max-w-2xl mx-auto"></p>

          <h2 className="text-4xl font-extrabold mb-4 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-transparent bg-clip-text"></h2>
          <p className=" text-neutral-content/80 max-w-2xl mx-auto"></p>
        </div>
