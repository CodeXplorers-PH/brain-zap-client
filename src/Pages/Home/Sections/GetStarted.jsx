  ...
  return (
    <section className="relative bg-gray-900 py-28 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-20 left-1/4 w-96 h-96 bg-purple-900/20 rounded-full filter blur-3xl opacity-20 animate-pulse" style={{ animationDuration: '8s' }}></div>
        <div className="absolute -bottom-20 right-1/4 w-96 h-96 bg-blue-900/20 rounded-full filter blur-3xl opacity-20 animate-pulse" style={{ animationDuration: '10s', animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gray-800/70 border border-gray-700 backdrop-blur-sm mb-6">
            ...
            <span className="text-sm font-medium text-gray-300">Simple Onboarding</span>
          </div>
        ...
        >
          {startSteps.map((step, index) => (
            ...
            >
              ...
              {/* Background gradient */}
              <div className={`absolute -right-24 -top-24 w-48 h-48 bg-gradient-to-br ${step.gradient} opacity-20 rounded-full blur-xl transition-all duration-500 group-hover:scale-150 group-hover:opacity-30`}></div>
              
              <div className="relative z-10">
                <div className={`w-12 h-12 bg-gradient-to-br ${step.gradient} rounded-xl flex items-center justify-center mb-6 shadow-lg shadow-purple-900/20 group-hover:scale-110 transition-transform duration-300`}>
                  {step.icon}
                </div>
