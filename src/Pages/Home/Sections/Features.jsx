  ...
  return (
    <section className="relative bg-gray-900 py-32 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-3/4 w-64 h-64 bg-pink-900/20 rounded-full filter blur-3xl opacity-10 animate-pulse"
                ...
                <div className="mb-8">
                  ...
                  >
                    <p className="text-gray-300 mb-4">
                      {activeFeature === 1 &&
                        "What's the primary advantage of using AI-powered quizzes?"}
                      {activeFeature === 2 &&
                        "How does personalized learning improve knowledge retention?"}
                      {activeFeature === 3 &&
                        "Which analytics feature provides the most value for learners?"}
                      {activeFeature === 4 &&
                        "What technique does BrainZap use to reinforce knowledge?"}
                    </p>
          ...
          >
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Our platform uses advanced machine learning to identify your
                unique strengths and weaknesses, creating optimal learning paths
                that adapt in real-time to maximize your potential.
              </p>
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-xl p-8 relative overflow-hidden">
            ...
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <p className="text-gray-400">
                Join the learning revolution and experience the power of
